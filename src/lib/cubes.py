...
from openspending.etl.ui.lib.aggregator import _aggregation_query
from openspending.etl.ui.lib.util import deep_get
...
class Cube(object):
    '''A cube that preaggregates :class:`openspending.etl.ui.model.Entry` entries.
    ...
    def __init__(self, dataset, cube_name):
        ...
        Arguments:
        ``dataset``
            A :class:`openspending.etl.ui.model.Dataset` object
        ``cube_name``
    ...
    def _cube_dimensions(self):
        ...
        for the cube does not exist as a :class:`openspending.etl.ui.mode.Dimension`
