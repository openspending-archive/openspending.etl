...
from openspending.etl.ui import logic, model
from openspending.etl.ui.lib import json
from openspending.etl.ui.lib.base import BaseController, render
from openspending.etl.ui.lib.browser import Browser
from openspending.etl.ui.lib.helpers import url_for
from openspending.etl.ui.lib.restapi import RestAPIMixIn
from openspending.etl.ui.lib.views import View, ViewState
from openspending.etl.ui.lib.views import handle_request
from openspending.etl.ui.plugins import PluginImplementations, IDatasetController
from openspending.etl.ui.lib import helpers as h, json
from openspending.etl.ui.lib.authz import requires
from openspending.etl.ui.lib.model import mongo
...
class DatasetController(BaseController, RestAPIMixIn):
    ...
    def _make_browser(self):
        url = url_for(controller='dataset', action='entries',
                      id=c.dataset.name)
