...
from openspending.etl.ui.lib.cubes import Cube, find_cube
from openspending.etl.ui.model import Dataset, Entry
...
class View(object):
    ...
    def apply_to(self, obj, filters):
        ...
        ``obj``
            a model object (instance of :class:`openspending.etl.ui.model.Base`)
        ``filter``
